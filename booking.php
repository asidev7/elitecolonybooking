		  ...
		  <ul class="slides">
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">Rester, c'est exister:  <span class="tm-yellow-text">mais voyager,</span> c'est vivre.</h1>
					<p class="tm-banner-subtitle">Avec ELITE COLONY</p>
					<a href="#more" class="tm-banner-link">INSCRIPTION</a>	
				</div>
				<img src="img/banner-1.jpg" alt="Image" />	
		    </li>
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">Lutte contre le racisme, <span class="tm-yellow-text">le régionalisme</span> ,les préjugés,</h1>
					<p class="tm-banner-subtitle">Amour , respect ,égalité ,partage , fraternité, travail,umanitaires</p>
					<a href="#more" class="tm-banner-link">INSCRIPTION</a>	
				</div>
		    ...
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">Offre des formation  <span class="tm-yellow-text">artisanales,</span>Aide des humanitaire </h1>
					<p class="tm-banner-subtitle">ELITE AFRICA</p>
					<a href="#more" class="tm-banner-link">INSCRIPTION</a>	
				</div>
				...
				<div class="tm-home-box-1">
					<ul class="nav nav-tabs tm-white-bg" role="tablist" id="hotelCarTabs">
					    <li role="presentation" class="active">
					    	<a href="#hotel" aria-controls="hotel" role="tab" data-toggle="tab">Individuel</a>
					    </li>
					    <li role="presentation">
					    	<a href="#car" aria-controls="car" role="tab" data-toggle="tab">En Groupe</a>
					    </li>
					</ul>
...
<option value="ZWE">Zimbabwe</option>
   ...
   <div class="form-group">
							                <div class='input-group name' id='ville'>
							                    <input type='text' class="form-control" placeholder="Villes" />
											...
											<div class="form-group">
							                <div class='input-group name' id='prenom'>
							            ...
							            <div class="form-group">
							                <div class='input-group name' id='number'>
							                    <input type='number' class="form-control" placeholder="Numéro de téléphone avec indicatif" />
							                    <span class="input-group-addon">
							            ...
							            <div class="form-group">
							                <div class='input-group email' id='email'>
							                    <input type='text' class="form-control" placeholder="Adresse electronique" />
							                    <span class="input-group-addon">
							          	...
							          	<div class="form-group">
							                <div class='input-group Proffesion' id='proffesion'>
							          	...
							          	<div class="form-group">
							                <div class='input-group date' id='datetimepicker2'>
							                    <input type='text' class="form-control" placeholder="Dtae de naissance" />
							                    <span class="input-group-addon">
						            ...
						            <div class="form-group tm-yellow-gradient-bg text-center">
						            	<button type="submit" name="submit" class="tm-yellow-btn">Payez 950€</button>
						            </div>  
								</form>
							</div>
					    </div>
...
<option value="ZWE">Zimbabwe</option>
   ...
   <div class="form-group">
							            ...
							            <div class="form-group margin-bottom-0">
											...
											<div class="form-group">
							                <div class='input-group name' id='name'>
							                    <input type='text' class="form-control" placeholder="Nom du digireant" />
							                    <span class="input-group-addon">
							                        <span class="fa fa-user"></span>
							                    </span>
							                </div>
											...
											<div class="form-group">
							                <div class='input-group name' id='prenom'>
							                    <input type='text' class="form-control" placeholder="Prénom du digireant" />
							                    <span class="input-group-addon">
							                        <span class="fa fa-user"></span>
							                    </span>
							                </div>
